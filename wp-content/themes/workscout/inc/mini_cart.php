...
<div id="cart" class="cart-in-header">
    ...
    <div class="cart-list">
        ...
        <div class="cart-buttons ">
            <a href="<?php echo WC()->cart->get_cart_url(); ?>" class="view-cart" ><span data-hover="<?php _e( 'View Cart &rarr;', 'workscout' ); ?>"><span><?php _e( 'View Cart &rarr;', 'workscout' ); ?></span></span></a>
            <a href="<?php echo WC()->cart->get_checkout_url(); ?>" class="checkout"><span data-hover="<?php _e( 'Checkout &rarr;', 'workscout' ); ?>"><?php _e( 'Checkout &rarr;', 'workscout' ); ?></span></a>
        </div>
        <div class="clearfix">
        </div>
    </div>
