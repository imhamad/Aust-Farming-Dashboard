...
//    'admin_enqueue_js' => array(get_template_directory_uri().'/vc_templates/js/vc_image_caption_box.js'),
   ...
   array(
        ...
        'param_name' => 'subtitle',
        'description' => esc_html__( 'Optional  subtitle', 'workscout' )
        ),
      array(
        'type' => 'font_container',
        ...
        'settings'=>array(
             'fields'=>array(
                 ...
                 'line_height',
                 'color',
                 'tag_description' => __('Select element tag.','workscout'),
                 'text_align_description' => __('Select text alignment.','workscout'),
                 'font_size_description' => __('Enter font size (add scale like px, %, em etc).','workscout'),
                 'line_height_description' => __('Enter line height (add scale like px, %, em etc).','workscout'),
                 'color_description' => __('Select color for your element.','workscout'),
             ),
         ),
      ),
      array(
      ...
      array(
          'type' => 'vc_link',
          'heading' => __( 'URL (Link)', 'workscout' ),
          'param_name' => 'url',
          'description' => __( 'Button link.', 'workscout' )
      ),
      array(
        'type' => 'dropdown',
